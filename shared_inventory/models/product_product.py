...
class ProductProduct(models.Model):
    ...
    def _compute_quantities_dict(self, lot_id=False, owner_id=False, package_id=False, from_date=False, to_date=False):
        ...
        for temp in self:
            ...
            counts = sku.product_tmpl_id._compute_product_quantities(lot_id, owner_id, package_id, from_date, to_date)
            total_qty[temp.id] = {
            ...
            for p in sku.sub_product_ids:
                counts = p.product_tmpl_id._compute_product_quantities(lot_id, owner_id, package_id, from_date, to_date)
